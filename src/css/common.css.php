...
fieldset legend {
    ...
    -moz-box-shadow: <?php echo $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>3px 3px 15px 5b0a53;
    -webkit-box-shadow: <?php echo $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>3px 3px 15px 5b0a53;
    box-shadow: <?php echo $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>3px 3px 15px 5b0a53;
    max-width: 100%;
}
...
.pma_sql_import_status div li {
    padding: 8px 10px;
    border-bottom: 1px solid 5b0a53;
    color: rgb(148, 14, 14);
    background: white;
}
...
meter[value="1"]::-webkit-meter-optimum-value {
    background: linear-gradient(white 3%, #60256b 5%, transparent 10%, #60256b);
}
